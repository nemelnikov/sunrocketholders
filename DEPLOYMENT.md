# How to deploy sunrocketholders
...
sudo service unicorn_sunrocketholders <start|stop|restart>
sudo service sidekiq_sunrocketholders <start|stop>
```
...
```
/home/deployer/apps/sunrocketholders/shared/.env.production
```

After making changes to this file, be sure to restart the application:

```
sudo service unicorn_sunrocketholders restart
sudo service sidekiq_sunrocketholders stop
sudo service sidekiq_sunrocketholders start
```
